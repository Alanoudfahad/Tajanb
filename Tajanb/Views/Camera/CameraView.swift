...
//                    if !isCameraRunning, !viewModel.selectedWordsViewModel.selectedWords.isEmpty {
            ...
            ZStack {
                ...
                VStack {
                    ...
                    if !isCameraRunning, !detectedItemsToDisplay.isEmpty {
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack(spacing: 10) {
                                ForEach(detectedItemsToDisplay) { detectedItem in
                                    Text(detectedItem.word)
                                        .font(.system(size: 14, weight: .medium))
                                        .padding(10)
                            ...
                            .accessibilityElement(children: .combine)
                            .accessibilityLabel(Text("Detected words: \(detectedWordsSummary)"))
                            .accessibilityHint("Swipe through detected words")
                            .padding(.horizontal, 20)
                            .padding(.top, 10)
                        }
